---
title: Contributing
description: How to contribute to GreenKube — code, documentation, bug reports, and feature requests.
---
...
# Create virtual environment and install all dependencies (dev + test)
uv sync
